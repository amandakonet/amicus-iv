...
#**Note: The data used in these models is *the full set* of abortion cases. Cases *without* amici are included and their frame measures are all 0s.**
```
