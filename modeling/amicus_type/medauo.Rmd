...
* 0:
* 0.01:
* 0.05: morality & religion (-)
* 0.10: abortion regret (+), women's future life (+)
* 0.20: undue burden (-), women's health (+)
...
saveRDS(mod14, "models/medauo_morality.rds")
saveRDS(mod9, "models/medauo_evidence.rds")
