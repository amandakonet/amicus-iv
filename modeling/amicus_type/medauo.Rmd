...
* 0:
* 0.01
* 0.05: morality/relig, protest
* 0.10: abortion regret
* 0.20: compulsory motherhood, undue burden, women's health
...
mod1 <- glmer(justicevot ~
                ...
                medauo_abortion_different + poppam,
...
mod6a <- glmer(justicevot ~
                (1|id) + justicemq + justicefem + nonftyp2 + lcdisdirfem +
                medauo_compulsory_motherhood + poppam,
              family = binomial, data = data,  
...
mod6b <- glmer(justicevot ~
                (1|id) + justicemq + justicefem + nonftyp2 + lcdisdirfem +
                medauo_compulsory_motherhood_ii + poppam,
              family = binomial, data = data,  
              nAGQ = 0, control=glmerControl(
                check.conv.grad="ignore",check.conv.singular="ignore",check.conv.hess="ignore"))
...
mod14 <- glmer(justicevot ~
                (1|id) + justicemq + justicefem + nonftyp2 + lcdisdirfem +
                medauo_morality_religion + poppam,
              family = binomial, data = data,  
              nAGQ = 0, control=glmerControl(
                check.conv.grad="ignore",check.conv.singular="ignore",check.conv.hess="ignore"))
...
mod25 <- glmer(justicevot ~
                (1|id) + justicemq + justicefem + nonftyp2 + lcdisdirfem +
                medauo_womens_future_life + poppam,
              family = binomial, data = data,  
              nAGQ = 0, control=glmerControl(
                check.conv.grad="ignore",check.conv.singular="ignore",check.conv.hess="ignore"))
