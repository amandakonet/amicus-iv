...
stargazer(forg_privacy, forg_privacy_interactions, forg_undue, forg_undue_interactions, lif_undue, lif_undue_interactions, relauo_undue, relauo_undue_interactions,
          title="Results", type='html',align=TRUE,
          column.labels = c("Forg Privacy", "Forg Undue", 
                            "Life Undue", "Relauo Undue"))
# , covariate.labels = c("Justice Ideology", "Justice Gender", "Lower Court Decision", "Solicitor General Amicus Brief", "pfemam", "forgauf_privacy", "justicemq:forgauf_privacy", "forgauf_undue_burden", "justicemq:forgauf_undue_burden", "poppam", "lifauo_undue_burden", "justicemq:lifauo_undue_burden"))
```
...
stargazer(forg_womenhealth, forg_womenhealth_interactions, medauf_womenhealth, medauf_womenhealth_interactions, forg_womenfuture, relauo_abortionregret, forg_evidence, forg_evidence_interactions, medauo_evidence, medauo_evidence_interactions
          ,title="Results", type='html',align=TRUE,
          column.labels = c("Forg Privacy", "Forg Undue", 
                            "Life Undue", "Relauo Undue"))
```
